...
GEN_IMG=yeasy/hyperledger-fabric:latest
...
docker exec -it $GEN_CONTAINER \
	configtxgen -profile TwoOrgsOrdererGenesis -outputBlock $ARTIFACTS_DIR/orderer_genesis.block
