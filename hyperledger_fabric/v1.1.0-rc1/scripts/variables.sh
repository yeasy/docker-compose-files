...
# Generate configs
GEN_IMG=yeasy/hyperledger-fabric:1.1.0-rc1  # working dir is `/go/src/github.com/hyperledger/fabric`
...
# CONFIGTXLATOR
CTL_IMG=yeasy/hyperledger-fabric:1.1.0-rc1
