...
FABRIC_CA_IMG_TAG=${FABRIC_CA_IMG_TAG:-1.5.15}
...
echo "=== Pulling Fabric runtime images... ==="
pull_image "hyperledger/fabric-peer:${FABRIC_IMG_TAG}" "true" &
pull_image "hyperledger/fabric-orderer:${FABRIC_IMG_TAG}" "true" &
pull_image "hyperledger/fabric-ca:${FABRIC_CA_IMG_TAG}" "true" &
wait
