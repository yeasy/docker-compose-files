# Hyperledger Fabric v3.0.0 examples

This directory contains the Fabric `v3.0.0` sample network used by this
repository.
...
- `DEV_MODE=dev` is intentionally disabled for `v3.0.0`. The old source-mounted
