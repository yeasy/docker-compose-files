...
are intentionally disabled for the `v3.0.0` setup.

### Verified lifecycle sequence

Run the following commands from `hyperledger_fabric/v3.0.0`:
...
See `../README.md` for the full `v3.0.0` notes and known limitations.

### External chaincode flow

The `v3.0.0` example installs `chaincode_example02` through CCAAS instead of
